  ...
  User.findOne({userId: id})
    .then(user => {
      switch (msg.data) {
        ...
        case 'c_reasons':
          bot.answerCallbackQuery({callback_query_id: msg.id})
            .then(() => MainController.showReasons(id, 'bots'))
          break
        ...
        case 'moreReason c_love':
          bot.answerCallbackQuery({callback_query_id: msg.id})
            .then(() => PageController.changePageReason(user, 'bots', 'add', msg.data))
          break
        ...
        case 'lessReason c_love':
          bot.answerCallbackQuery({callback_query_id: msg.id})
            .then(() => PageController.changePageReason(user, 'bots', 'remove', msg.data))
          break
        ...
        case 'startReason c_love':
          bot.answerCallbackQuery({callback_query_id: msg.id})
              .then(() => PageController.changePageReason(user, 'bots', 'reset', msg.data))
          break
